import { Flex, Text, Heading, Image, FormControl, FormLabel, Input, Button, CircularProgress, useToast } from "@chakra-ui/react";
import { useMediaQuery } from "react-responsive";
import { theme } from "../../theme";
import SignIn from "../../assets/signin.svg";
import { useState } from "react";
import { useNavigate } from "react-router-dom";
import { signUp } from "../../services/UserManagementServices/UserManagementService";
...
function SignUpPage() {
    ...
    const handleSubmit = async (event) => {
        ...
        if (response.user_id) {
            ...
            toast({
                title: 'Sign-up error',
                description: "We could not sign you up!",
                status: 'error',
                ...
                <form onSubmit={handleSubmit}>
                    <Flex flexDir="column" w="300px" mt="32px">
                        ...
                        <Button type="submit" _hover={{ backgroundColor: theme.accent }} backgroundColor={theme.accent} color={theme.secondaryForeground} mt="24px">
                            {
                                loading === "false" ? <Text>Sign-Up</Text> :
                        ...
                        <Flex mt="4px">
                            ...
                            <button onClick={() => navigate('/user/sign-in')}>
                                <Text fontSize="sm" fontWeight="bold">Sign-in</Text>
                            </button>
                        </Flex>
                    </Flex>
